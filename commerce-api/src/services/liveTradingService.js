...
function normalizeLiveTradingPayload(payload) {
    ...
    const snapshot = {
        ...
        todayProfit: normalizeFinite(readFirst(performance, [
            "closedPLThisTradingDay",
            "closed_pl_this_trading_day",
            "closedPnlThisTradingDay",
            "closed_pnl_this_trading_day",
            "closedTradingDayPL",
            "closed_trading_day_pl",
            "closedTradingDayPnl",
            "closed_trading_day_pnl",
            "tradingDayClosedPL",
            "trading_day_closed_pl",
            "closedPnlToday",
            "closed_pnl_today",
            "todayProfit",
            "today_profit",
