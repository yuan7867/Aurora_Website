...
const faqs = [
    ...
    ["Is live trading data real on this page?", "Live values are requested from Aurora Cloud API. If the cloud is offline, the website shows a connecting state instead of fake numbers."],
